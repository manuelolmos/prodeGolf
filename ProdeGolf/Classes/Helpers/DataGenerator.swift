...
struct DataGenerator {
    ...
    private let ranking = [
        ...
        ["Cameron Smith", "Joaquin Niemann", "Abraham Ancer", "Thomas Pieters", "Talor Gooch", "Mito Pereira", "Dustin Johnson", "Patrick Reed", "Jason Kokrak", "Kevin Na", "Brooks Koepka", "Louis Oosthuizen", "Bryson DeChambeau", "Sergio Garcia", "Bubba Watson", "Charl Schwartzel", "Phil Mickelson"]
    ]
